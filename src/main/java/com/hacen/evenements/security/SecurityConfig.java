...
public class SecurityConfig {
	...
	@Bean
	 ...
	 .requestMatchers("/showCreate","/saveEvenement").hasAnyAuthority("ADMIN","AGENT","USER")
	 .requestMatchers("/modifierEvenement","/supprimerEvenement").hasAuthority("ADMIN")
	...
	/* @Bean
	 ...
	 return new InMemoryUserDetailsManager(admin, userHacen,user1);
	 }
	*/
